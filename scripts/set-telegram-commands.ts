...
const COMMANDS: TelegramCommand[] = [
  ...
  { command: 'deals_on', description: 'Nhan deal hot Shopee/Taobao' },
  { command: 'deals_off', description: 'Tat nhan deal hot' },
  { command: 'deal_settings', description: 'Trang thai nhan deal' },
